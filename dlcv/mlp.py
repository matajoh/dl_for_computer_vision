...
def train_mlp(dataset: MulticlassDataset, net: MultiLayerPerceptron,
...
def attack_mlp(x: np.ndarray, t0: np.ndarray, t1: np.ndarray, model: nn.Module, criterion: nn.Module):
